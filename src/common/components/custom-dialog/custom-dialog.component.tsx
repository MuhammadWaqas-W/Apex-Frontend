...
export default function CustomDialog({ thead, openModal, setOpenModal, selectedRow }: any) {
    ...
    <>
      ...
      >
        ...
        <DialogContent dividers>
          {thead === "policy" && <ModelData selectedRow={selectedRow} />}
