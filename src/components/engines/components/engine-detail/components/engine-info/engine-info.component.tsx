  ...
  return (
    <Grid container item lg={12} sx={EngineInfoStyle.mainContent}>
      ...
      >
        ...
        <Grid container sx={EngineInfoStyle.descriptionContainer}>
        ...
        <Grid container>
          <Grid lg={12} xs={12} sx={EngineInfoStyle.socialImages}>
            <Grid container>
              ...
              <Typography sx={EngineInfoStyle.image2}>
                <img src="/image/drive.png" alt="Drive Img" />
              </Typography>
            </Grid>
          </Grid>
        </Grid>
      ...
      >
        ...
        <Typography sx={EngineInfoStyle.modalTxt}>Company Slackbot</Typography>
      ...
      <Grid item lg={12} sx={EngineInfoStyle.activeContent}>
        <Grid container>
          <Grid lg={0.9} xl={0.75} sm={12} xs={12} md={12}>
            ...
            >
              <LensIcon sx={{ fontSize: "10px" }} /> Active
            </Typography>
          </Grid>
