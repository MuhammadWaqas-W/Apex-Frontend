          ...
          <Grid className="first_node">
            <Box>
              <a
                ...
                target="_blank"
              >
                <img src="/image/saleforce.png" alt="images" />
              </a>
              <a
                ...
                target="_blank"
              >
                <img src="/image/drive.png" alt="images" />
              </a>
            </Box>
          </Grid>
...
const initialEdges = [
  { type: "smoothstep", id: "1", source: "1", target: "2" },
  { type: "smoothstep", id: "2", source: "2", target: "5" },
  { type: "smoothstep", id: "4", source: "2", target: "10" },
  { type: "smoothstep", id: "5", source: "10", target: "8" },
  { type: "smoothstep", id: "6", source: "5", target: "12" },
  { type: "smoothstep", id: "7", source: "5", target: "11" },
  { type: "smoothstep", id: "8", source: "9", target: "11" },
  { type: "smoothstep", id: "9", source: "8", target: "13" },
  { type: "smoothstep", id: "10", source: "13", target: "17" },
  { type: "smoothstep", id: "11", source: "17", target: "14" },
  { type: "smoothstep", id: "12", source: "14", target: "20" },
];
function ZoomIn() {
  ...
  return (
    <>
      <Grid container sx={Style.FlowChart} style={{ zoom: 0.7  , justifyContent:"center"}}>
        <ReactFlow
          nodes={nodes}
          edges={edges}
