    ...
    data: {
      label: (
        <Grid className="third_node" container>
          ...
          <p style={{ marginTop: "17px" ,fontFamily: 'Inter, sans-serif'}} className="description_footer">
            Azure OpenAI
          </p>
          <p className="description_footer" style={{ fontFamily: 'Inter, sans-serif' }}>GPT4</p>
        </Grid>
      ),
      Style: {
        color: "red",
    ...
    data: {
      label: (
        <Grid className="fourht_node" container>
          ...
          />
          <span style={{ fontFamily: 'Inter, sans-serif' }}>Restrict Access</span>
        </Grid>
      ),
      Style: {
        color: "red",
      ...
      label: (
        <Grid className="fifth_node" container>
          <BackHandIcon
            style={{ fontSize: "16px", marginRight: "10px", color: "#1570EF" }}
          />
          <span style={{ fontFamily: 'Inter, sans-serif' }}>Enforce 3 GDPR policies</span>
        </Grid>
      ),
      Style: {
        color: "red",
...
const initialEdges = [
  { type: "smoothstep", id: "1", source: "1", target: "3" },
  { type: "smoothstep", id: "2", source: "2", target: "4" },
  { type: "smoothstep", id: "3", source: "4", target: "3" },
  { type: "smoothstep", id: "4", source: "3", target: "5" },
  { type: "smoothstep", id: "5", source: "5", target: "6" },
  { type: "smoothstep", id: "6", source: "3", target: "7" },
  { type: "smoothstep", id: "7", source: "7", target: "8" },
  { type: "smoothstep", id: "8", source: "8", target: "9" },
  { type: "smoothstep", id: "10", source: "10", target: "11" },
  { type: "smoothstep", id: "11", source: "11", target: "12" },
  { type: "smoothstep", id: "12", source: "12", target: "13" },
  { type: "smoothstep", id: "13", source: "13", target: "9" },
];
function ZoomOut() {
  ...
  return (
    <>
      <Grid container sx={Style.FlowChart_one} style={{ zoom: 0.7 , pointerEvents: 'none' }}>
        <ReactFlow
          nodes={nodes}
          edges={edges}
